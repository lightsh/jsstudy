...
* 하이퍼링크를 클릭하면 해당 ```<div class="miniTabContent">``` 만 보여주세요.(div.miniTab  ul.miniTabHeader li a 만 해당됨)
  - Tutorial : Writing a game program in JavaScript – Introduction -> 첫번째 ```<div class="miniTabContent">``` 만 보여주세요.
```html
...
``` 
  - Tutorial : Writing a game program in JavaScript – Part 1 -> 두번째 ```<div class="miniTabContent">``` 만 보여주세요.
```html
		<div class="miniTabContent">  
...
``` 
  ...
  - Tutorial : Writing a game program in JavaScript – Part 2 -> 세번째 ```<div class="miniTabContent">``` 만 보여주세요.
 ```html
		<div class="miniTabContent">
...
> 초기 화면
![TODO03](https://github.com/ByungChangYoo/clipsoft/blob/master/javascript/15-2015년01월07일/todo/images/todo_03_01.png)

> Tutorial : Writing a game program in JavaScript – Introduction 클릭했을 때 화면
![TODO03](https://github.com/ByungChangYoo/clipsoft/blob/master/javascript/15-2015년01월07일/todo/images/todo_03_02.png)

> Tutorial : Writing a game program in JavaScript – Part 1 클릭했을 때 화면 
![TODO03](https://github.com/ByungChangYoo/clipsoft/blob/master/javascript/15-2015년01월07일/todo/images/todo_03_03.png)

> Tutorial : Writing a game program in JavaScript – Part 2 클릭했을 때 화면
![TODO03](https://github.com/ByungChangYoo/clipsoft/blob/master/javascript/15-2015년01월07일/todo/images/todo_03_04.png)
