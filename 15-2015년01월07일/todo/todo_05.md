...
* TODO 04 까지 개발했던 로직을 모두 jQuery 로 수정해주세요.
- http://code.jquery.com/jquery-1.7.1.min.js
* http://www.w3schools.com/jquery/default.asp 사이트를 참고하세요.
* HTML은 수정하지 말고 JavaScript 만을 사용해서 구현해주세요.

> 초기 화면
![TODO05](https://github.com/ByungChangYoo/clipsoft/blob/master/javascript/15-2015년01월07일/todo/images/todo_05_01.png)


> Tutorial : Writing a game program in JavaScript – Introduction 클릭했을 때 화면
![TODO05](https://github.com/ByungChangYoo/clipsoft/blob/master/javascript/15-2015년01월07일/todo/images/todo_05_02.png)
