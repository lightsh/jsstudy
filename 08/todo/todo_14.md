...
function cal(list) {
	...
	var all = list.map(function(student) {
		return student.score.sort(function(a, b) { return a - b; }).slice(1, 3).reduce(sum);
	});
...
![TODO14](https://github.com/ByungChangYoo/clipsoft/blob/master/javascript/08/todo/images/todo_01.png)


>  결과 화면

![TODO14](https://github.com/ByungChangYoo/clipsoft/blob/master/javascript/08/todo/images/todo_01_result.png)
