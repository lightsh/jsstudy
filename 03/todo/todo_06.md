...
* 위쪽 테이블에서 "add" 버튼을 눌렀을 때 이름(name)에 대해서 유효성 검사를 해주세요.
* `빈문자` 또는 `숫자`이면 경고 메시지를 보여줍니다.
* 유효성 검사에 오류가 있으면 아래쪽 테이블에 추가하지 않습니다.
* 아래쪽 테이블도 편집할 때 이름(score)에 대해서 유효성 검사를 해주세요.
* HTML의 모양새는 아래 HTML template을 사용하고 JavaScript 만 작성해주세요.


> 입력 화면

![TODO06](https://github.com/ByungChangYoo/clipsoft/blob/master/javascript/03/todo/images/todo_06.png)


> 편집 화면

![TODO06](https://github.com/ByungChangYoo/clipsoft/blob/master/javascript/03/todo/images/todo_06_edit.png)
