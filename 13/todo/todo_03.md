...
```javascript
	function GameTetris() {
		...
		//
		// TO DO : startGame 함수를 수정해주세요.
		//  
		//  -  2X2 파란색 블럭과  2X4 파란색 블럭이 교대로 나오도록 수정해주세요.
...
![TODO03](https://github.com/ByungChangYoo/clipsoft/blob/master/javascript/13/todo/images/todo_03.gif)
